...
const _excluded = ["children", "sx", "extendVertically", "hideLegend", "legendDirection", "legendPosition"];
 ...
 */
const ChartsWrapper = exports.ChartsWrapper = /*#__PURE__*/React.forwardRef(function ChartsWrapper(props, ref) {
  const {
      children,
      sx,
      extendVertically,
  ...
  const handleRef = (0, _useForkRef.default)(chartRootRef, ref);
