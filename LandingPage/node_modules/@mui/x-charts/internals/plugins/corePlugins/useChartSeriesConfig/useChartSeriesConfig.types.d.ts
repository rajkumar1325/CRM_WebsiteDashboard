...
export type CleanIdentifierFunction = {
  <SeriesType extends ChartSeriesType, Item extends SeriesItemIdentifierWithType<SeriesType>>(identifier: Item, typeOfIdentifier: 'seriesItem'): Item;
  <SeriesType extends ChartSeriesType, Item extends HighlightItemIdentifierWithType<SeriesType>>(identifier: Item, typeOfIdentifier: 'highlightItem'): Item;
  <SeriesType extends ChartSeriesType, Item extends VisibilityIdentifierWithType<SeriesType>>(identifier: Item, typeOfIdentifier: 'visibility'): Item;
};
