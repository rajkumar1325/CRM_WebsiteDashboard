...
import type { HighlightItemIdentifierWithType, HighlightItemIdentifier, SeriesItemIdentifier, SeriesItemIdentifierWithType } from "../../../../models/seriesType/index.mjs";
...
export interface UseChartHighlightInstance<SeriesType extends ChartSeriesType> {
   ...
   */
  setHighlight: (item: HighlightItemIdentifier<SeriesType> | SeriesItemIdentifier<SeriesType> | HighlightItemIdentifierWithType<SeriesType> | SeriesItemIdentifierWithType<SeriesType>) => void;
}
export interface UseChartHighlightParameters<SeriesType extends ChartSeriesType> {
   ...
   */
  highlightedItem?: HighlightItemIdentifier<SeriesType> | HighlightItemIdentifierWithType<SeriesType> | null;
  /**
...
export type UseChartHighlightDefaultizedParameters<SeriesType extends ChartSeriesType> = DefaultizedProps<UseChartHighlightParameters<SeriesType>, 'highlightedItem'>;
