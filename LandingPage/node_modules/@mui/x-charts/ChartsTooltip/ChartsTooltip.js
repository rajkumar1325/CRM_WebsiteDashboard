...
const _excluded = ["classes", "trigger", "sort"];
/**
 * Demos:
 *
...
function ChartsTooltip(props) {
  const {
    ...
    containerProps = (0, _objectWithoutPropertiesLoose2.default)(props, _excluded);
  const classes = (0, _chartsTooltipClasses.useUtilityClasses)(propClasses);
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ChartsTooltipContainer.ChartsTooltipContainer, (0, _extends2.default)({}, containerProps, {
    trigger: trigger,
    classes: propClasses,
