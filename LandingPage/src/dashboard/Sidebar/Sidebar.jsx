...
// ─────────────────────────────────────────────────────────────────────────────
const NAV_ITEMS = [
  { to: "/dashboard",              label: "Home",     Icon: Home,          allowedRoles: ["ADMIN","EMPLOYEE","CUSTOMER"] },
  { to: "/dashboard/leads",        label: "Leads",    Icon: UsersRound,    allowedRoles: ["ADMIN","EMPLOYEE"] },
  { to: "/dashboard/customers",    label: "Customers",Icon: Users,         allowedRoles: ["ADMIN","EMPLOYEE"] },
  { to: "/dashboard/deals",        label: "Deals",    Icon: Handshake,     allowedRoles: ["ADMIN","EMPLOYEE"] },
  { to: "/dashboard/products",     label: "Products", Icon: Package,       allowedRoles: ["ADMIN","EMPLOYEE","CUSTOMER"] },
  { to: "/dashboard/projects",     label: "Projects", Icon: FolderKanban,  allowedRoles: ["ADMIN","CUSTOMER"] },
  { to: "/dashboard/taskAndActivities", label: "Tasks", Icon: ClipboardList, allowedRoles: ["ADMIN","EMPLOYEE"] },
  { to: "/dashboard/calendar",     label: "Calendar", Icon: CalendarDays,  allowedRoles: ["ADMIN","EMPLOYEE"] },
  { to: "/dashboard/support",      label: "Support",  Icon: Headphones,    allowedRoles: ["ADMIN","EMPLOYEE","CUSTOMER"] },
  { to: "/dashboard/team",         label: "Team",     Icon: UserRound,     allowedRoles: ["ADMIN"] },
  { to: "/dashboard/reports",      label: "Reports",  Icon: BarChart3,     allowedRoles: ["ADMIN"] },
  { to: "/dashboard/settings",     label: "Settings", Icon: SettingsIcon,  allowedRoles: ["ADMIN","EMPLOYEE","CUSTOMER"] },
];
